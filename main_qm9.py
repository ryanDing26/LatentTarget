...
parser.add_argument('--dataset', type=str, default='cd2020',
                    help='qm9 | qm9_second_half (train only on the last 50K samples of the training dataset) | cd2020')
...
parser.add_argument('--remove_h', action='store_true') # by default, hydrogens are not removed unless this is specified
...
def main():
    ...
    for epoch in range(args.start_epoch, args.n_epochs):
        ...
        # Settings
        # train on training split for 3000 epochs
        # 
